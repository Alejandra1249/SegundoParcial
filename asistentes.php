...
<div class="jumbotron">
	...
	<h1 class="text-center"> Asistentes </h1>
</div>
...
$insertar = ("INSERT INTO segparcial.asistentes(nombre, apellido, correoa) VALUES ('$nombre','$apellido','$correoa')");
...
<html lang="en">
  ...
  <body>
   ...
   <form class="form-signin" method="POST" enctype="multipart/form-data">
    <span><h2><b><center>Registro de Asistentes</center></b></h2></span>
      ...
      <div class="form-label-group">
        <input type="text" id="correoa" name="correoa" class="form-control" placeholder="Correo de Asistente" required autofocus>
      </div>
